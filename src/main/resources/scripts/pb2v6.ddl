...
CREATE TABLE opciones_pregunta (
                                   ...
                                   p_p_p_e_e_codigoexamen      INTEGER NOT NULL,
                                   p_p_p_e_p_codigopregunta    INTEGER NOT NULL,
                                   p_a_a_usuario_codigousuario INTEGER NOT NULL
)
    PCTFREE 15 PCTUSED 70 LOGGING
    STORAGE ( PCTINCREASE 0 MINEXTENTS 1 MAXEXTENTS UNLIMITED FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT );
...
ALTER TABLE pregunta_alumno
    ADD CONSTRAINT pregunta_parcial_pk PRIMARY KEY ( pe_examen_codigoexamen,
                                                     pe_pregunta_codigopregunta,
                                                     alumno_usuario_codigousuario );
...
ALTER TABLE opciones_pregunta
    ADD CONSTRAINT o_p_p_parcial_fk FOREIGN KEY ( p_p_p_e_e_codigoexamen,
                                                  p_p_p_e_p_codigopregunta,
                                                  p_a_a_usuario_codigousuario )
...
ALTER TABLE pregunta_alumno
    ADD CONSTRAINT pregunta_parcial_alumno_fk FOREIGN KEY ( alumno_usuario_codigousuario )
        REFERENCES alumno ( usuario_codigousuario )
            NOT DEFERRABLE;
